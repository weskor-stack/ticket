<?php
    ...
    while ($fila = $resultado->fetch_assoc()) {
        ...
        VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','10','17','15','".$fila['coust']."')");
    ...
    $equipo_especial = $mysqli->query("SELECT * FROM tmp_products WHERE `kind_item` = 'MATERIALES' AND `line`= 'NEUMATICO' AND `sub_line`='EQUIPO ESPECIAL'  AND `unit_measure`='Pieza'");
        ...
        while ($fila = $equipo_especial->fetch_assoc()) {
            $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
            VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','10','17','22','".$fila['coust']."')");
        ...
        while ($fila = $equipo_especial_kit->fetch_assoc()) {
           $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
            VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','5','17','22','".$fila['coust']."')");
        ...
        while ($fila = $cilindros->fetch_assoc()) {
            $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
            VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','10','17','9','".$fila['coust']."')");
        ...
        while ($fila = $valvulas->fetch_assoc()) {
            $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
            VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','10','17','57','".$fila['coust']."')");
        ...
        while ($fila = $mangueras_pieza->fetch_assoc()) {
            $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
            VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','10','17','33','".$fila['coust']."')");
        ...
        while ($fila = $mangueras_metro->fetch_assoc()) {
            $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
            VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','7','17','33','".$fila['coust']."')");
        ...
        while ($fila = $mecanica->fetch_assoc()) {
            $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
            VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','10','17','38','".$fila['coust']."')");
        ...
        while ($fila = $neumatico_unidades_medida->fetch_assoc()) {
            $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
            VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','10','17','55','".$fila['coust']."')");
        ...
        while ($fila = $neumatico_fijaciones->fetch_assoc()) {
            $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
            VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','10','17','27','".$fila['coust']."')");
        ...
        while ($fila = $neumatico_componentes->fetch_assoc()) {
            $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
            VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','10','17','13','".$fila['coust']."')");
        ...
        while ($fila = $ee_accesorios->fetch_assoc()) {
            ...
            $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
            VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','10','5','1','".$fila['coust']."')");
        ...
        while ($fila = $ee_electrica->fetch_assoc()) {
            ...
            $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
            VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','10','5','2','".$fila['coust']."')");
        ...
        while ($fila = $ee_arrancadores->fetch_assoc()) {
            ...
            $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
            VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','10','5','4','".$fila['coust']."')");
        ...
        while ($fila = $ee_baterias_cargadores->fetch_assoc()) {
            ...
            $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
            VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','10','5','5','".$fila['coust']."')");
        ...
        while ($fila = $ee_botones->fetch_assoc()) {
            ...
            $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
            VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','10','5','6','".$fila['coust']."')");
        ...
        while ($fila = $ee_cable_estandar_pieza->fetch_assoc()) {
            ...
            $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
            VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','10','5','7','".$fila['coust']."')");
        ...
        while ($fila = $ee_canaletas->fetch_assoc()) {
            ...
            $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
            VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','10','5','8','".$fila['coust']."')");
        ...
        while ($fila = $ee_clemas->fetch_assoc()) {
            ...
            $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
            VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','10','5','10','".$fila['coust']."')");
        ...
        while ($fila = $ee_componentes_pieza->fetch_assoc()) {
            ...
            $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
            VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','10','5','13','".$fila['coust']."')");
        ...
        while ($fila = $ee_comunicaciones->fetch_assoc()) {
            ...
            $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
            VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','10','5','14','".$fila['coust']."')");
        ...
        while ($fila = $ee_control_movimiento->fetch_assoc()) {
            ...
            $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
            VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','10','5','17','".$fila['coust']."')");
        ...
        while ($fila = $ee_control_vpte->fetch_assoc()) {
            ...
            $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
            VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','10','5','18','".$fila['coust']."')");
        ...
        while ($fila = $ee_desconectadores->fetch_assoc()) {
            ...
            $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
            VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','10','5','20','".$fila['coust']."')");
        ...
        while ($fila = $ee_computo->fetch_assoc()) {
            ...
            $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
            VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','10','5','21','".$fila['coust']."')");
        ...
        while ($fila = $ee_equipo_especial->fetch_assoc()) {
            ...
            if($fila['unit_measure']=='Juego'){
                $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','3','5','22','".$fila['coust']."')");
            }else{
                if($fila['unit_measure']=='Kilogramo'){
                    $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                    VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','4','5','22','".$fila['coust']."')");
                }else{
                    if($fila['unit_measure']=='Pieza'){
                        $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                        VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','10','5','22','".$fila['coust']."')");
                    }
                }
            }
            $index ++;
        ...
        while ($fila = $ee_plc->fetch_assoc()) {
            ...
            $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
            VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','10','5','44','".$fila['coust']."')");
        ...
        while ($fila = $ee_relevadores->fetch_assoc()) {
            ...
            $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
            VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','10','5','45','".$fila['coust']."')");
        ...
        while ($fila = $ee_robots->fetch_assoc()) {
            ...
            $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
            VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','10','5','46','".$fila['coust']."')");
        ...
        while ($fila = $ee_sensores->fetch_assoc()) {
            ...
            $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
            VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','10','5','49','".$fila['coust']."')");
        ...
        while ($fila = $ee_transformador->fetch_assoc()) {
            ...
            $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
            VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','10','5','53','".$fila['coust']."')");
        ...
        while ($fila = $ee_variadores->fetch_assoc()) {
            if($fila['unit_measure']=='Kilogramo'){
                $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','4','5','58','".$fila['coust']."')");
            }else{
                if($fila['unit_measure']=='Pieza'){
                    $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                    VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','10','5','58','".$fila['coust']."')");
                }
            }
            $index ++;
        }
        ...
        while ($fila = $h_hidraulico->fetch_assoc()) {
            // $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
            // VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','10','11','15','".$fila['coust']."')");
            ...
            if($fila['sub_line']=='CONEXIONES'){
                ...
                if($fila['sub_line']=='EQUIPO ESPECIAL'){
                    $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                    VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','10','11','22','".$fila['coust']."')");
                }else{
                    if($fila['sub_line']=='MANGUERAS'){
                        $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                        VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','10','11','33','".$fila['coust']."')");
                    }else{
                        if($fila['sub_line']=='UNIDADES HIDRAULICAS'){
                            $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                            VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','10','11','56','".$fila['coust']."')");
                        }else{
                            if($fila['sub_line']=='VALVULAS'){
                                $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                                VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','10','11','57','".$fila['coust']."')");
                            }
                        }
                    }
                }
        ...
        while ($fila = $m_mecanico->fetch_assoc()) {
            ...
            if($fila['unit_measure']=='Centimetro'){
                $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','1','14','25','".$fila['coust']."')");
            }else{
                if($fila['unit_measure']=='Kilogramo'){
                    $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                    VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','4','14','25','".$fila['coust']."')");
                }else{
                    if($fila['unit_measure']=='Litro'){
                        $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                        VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','6','14','25','".$fila['coust']."')");
                    }else{
                        if($fila['unit_measure']=='Metro'){
                            $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                            VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','7','14','25','".$fila['coust']."')");
                        }else{
                            if($fila['unit_measure']=='Par'){
                                $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                                VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','9','14','25','".$fila['coust']."')");
                            }else{
                                if($fila['unit_measure']=='Pieza'){
                                    $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                                    VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','10','14','25','".$fila['coust']."')");
                                }
                            }
                        }
                    }
        ...
        while ($fila = $m_fijaciones->fetch_assoc()) {
            ...
            if($fila['unit_measure']=='Centimetro'){
                $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','1','14','27','".$fila['coust']."')");
            }else{
                if($fila['unit_measure']=='Kilogramo'){
                    $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                    VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','4','14','27','".$fila['coust']."')");
                }else{
                    if($fila['unit_measure']=='Litro'){
                        $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                        VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','6','14','27','".$fila['coust']."')");
                    }else{
                        if($fila['unit_measure']=='Metro'){
                            $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                            VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','7','14','27','".$fila['coust']."')");
                        }else{
                            if($fila['unit_measure']=='Par'){
                                $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                                VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','9','14','27','".$fila['coust']."')");
                            }else{
                                if($fila['unit_measure']=='Pieza'){
                                    $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                                    VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','10','14','27','".$fila['coust']."')");
                                }
                            }
                        }
                    }
        ...
        while ($fila = $m_manuales->fetch_assoc()) {
            ...
            if($fila['unit_measure']=='Centimetro'){
                $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','1','14','35','".$fila['coust']."')");
            }else{
                if($fila['unit_measure']=='Kilogramo'){
                    $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                    VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','4','14','35','".$fila['coust']."')");
                }else{
                    if($fila['unit_measure']=='Litro'){
                        $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                        VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','6','14','35','".$fila['coust']."')");
                    }else{
                        if($fila['unit_measure']=='Metro'){
                            $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                            VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','7','14','35','".$fila['coust']."')");
                        }else{
                            if($fila['unit_measure']=='Par'){
                                $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                                VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','9','14','35','".$fila['coust']."')");
                            }else{
                                if($fila['unit_measure']=='Pieza'){
                                    $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                                    VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','10','14','35','".$fila['coust']."')");
                                }
                            }
                        }
                    }
        ...
        while ($fila = $m_metales->fetch_assoc()) {
            ...
            if($fila['unit_measure']=='Centimetro'){
                $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','1','14','40','".$fila['coust']."')");
            }else{
                if($fila['unit_measure']=='Kilogramo'){
                    $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                    VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','4','14','40','".$fila['coust']."')");
                }else{
                    if($fila['unit_measure']=='Litro'){
                        $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                        VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','6','14','40','".$fila['coust']."')");
                    }else{
                        if($fila['unit_measure']=='Metro'){
                            $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                            VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','7','14','40','".$fila['coust']."')");
                        }else{
                            if($fila['unit_measure']=='Par'){
                                $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                                VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','9','14','40','".$fila['coust']."')");
                            }else{
                                if($fila['unit_measure']=='Pieza'){
                                    $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                                    VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','10','14','40','".$fila['coust']."')");
                                }
                            }
                        }
                    }
        ...
        while ($fila = $m_perfileria->fetch_assoc()) {
            ...
            if($fila['unit_measure']=='Centimetro'){
                $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','1','14','41','".$fila['coust']."')");
            }else{
                if($fila['unit_measure']=='Kilogramo'){
                    $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                    VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','4','14','41','".$fila['coust']."')");
                }else{
                    if($fila['unit_measure']=='Litro'){
                        $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                        VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','6','14','41','".$fila['coust']."')");
                    }else{
                        if($fila['unit_measure']=='Metro'){
                            $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                            VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','7','14','41','".$fila['coust']."')");
                        }else{
                            if($fila['unit_measure']=='Par'){
                                $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                                VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','9','14','41','".$fila['coust']."')");
                            }else{
                                if($fila['unit_measure']=='Pieza'){
                                    $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                                    VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','10','14','41','".$fila['coust']."')");
                                }
                            }
                        }
                    }
        ...
        while ($fila = $m_pinturas->fetch_assoc()) {
            ...
            if($fila['unit_measure']=='Centimetro'){
                $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','1','14','42','".$fila['coust']."')");
            }else{
                if($fila['unit_measure']=='Kilogramo'){
                    $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                    VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','4','14','42','".$fila['coust']."')");
                }else{
                    if($fila['unit_measure']=='Litro'){
                        $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                        VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','6','14','42','".$fila['coust']."')");
                    }else{
                        if($fila['unit_measure']=='Metro'){
                            $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                            VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','7','14','42','".$fila['coust']."')");
                        }else{
                            if($fila['unit_measure']=='Par'){
                                $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                                VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','9','14','42','".$fila['coust']."')");
                            }else{
                                if($fila['unit_measure']=='Pieza'){
                                    $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                                    VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','10','14','42','".$fila['coust']."')");
                                }
                            }
                        }
                    }
        ...
        while ($fila = $m_plasticos->fetch_assoc()) {
            if($fila['unit_measure']=='Centimetro'){
                $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','1','14','43','".$fila['coust']."')");
            }else{
                if($fila['unit_measure']=='Kilogramo'){
                    $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                    VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','4','14','43','".$fila['coust']."')");
                }else{
                    if($fila['unit_measure']=='Litro'){
                        $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                        VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','6','14','43','".$fila['coust']."')");
                    }else{
                        if($fila['unit_measure']=='Metro'){
                            $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                            VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','7','14','43','".$fila['coust']."')");
                        }else{
                            if($fila['unit_measure']=='Par'){
                                $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                                VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','9','14','43','".$fila['coust']."')");
                            }else{
                                if($fila['unit_measure']=='Pieza'){
                                    $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                                    VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','10','14','43','".$fila['coust']."')");
                                }
                            }
                        }
                    }
        ...
        while ($fila = $m_rodamientos->fetch_assoc()) {
            if($fila['unit_measure']=='Centimetro'){
                $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','1','14','47','".$fila['coust']."')");
            }else{
                if($fila['unit_measure']=='Kilogramo'){
                    $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                    VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','4','14','47','".$fila['coust']."')");
                }else{
                    if($fila['unit_measure']=='Litro'){
                        $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                        VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','6','14','47','".$fila['coust']."')");
                    }else{
                        if($fila['unit_measure']=='Metro'){
                            $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                            VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','7','14','47','".$fila['coust']."')");
                        }else{
                            if($fila['unit_measure']=='Par'){
                                $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                                VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','9','14','47','".$fila['coust']."')");
                            }else{
                                if($fila['unit_measure']=='Pieza'){
                                    $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                                    VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','10','14','47','".$fila['coust']."')");
                                }
                            }
                        }
                    }
        ...
        while ($fila = $m_tratamientos->fetch_assoc()) {
            if($fila['unit_measure']=='Centimetro'){
                $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','1','14','54','".$fila['coust']."')");
            }else{
                if($fila['unit_measure']=='Kilogramo'){
                    $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                    VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','4','14','54','".$fila['coust']."')");
                }else{
                    if($fila['unit_measure']=='Litro'){
                        $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                        VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','6','14','54','".$fila['coust']."')");
                    }else{
                        if($fila['unit_measure']=='Metro'){
                            $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                            VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','7','14','54','".$fila['coust']."')");
                        }else{
                            if($fila['unit_measure']=='Par'){
                                $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                                VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','9','14','54','".$fila['coust']."')");
                            }else{
                                if($fila['unit_measure']=='Pieza'){
                                    $insert =$mysqli->query("INSERT INTO tmp_material (material_id,`key`,`name`,stock,material_classifier_id,unit_measure_id,`line`,sub_line,material_coust)
                                    VALUES (NULL,'".$fila['key_product']."','".trim($fila['names'])."','".$fila['inventary']."','4','10','14','54','".$fila['coust']."')");
                                }
                            }
                        }
                    }
        ...
        // $insert =$mysqli->query("INSERT INTO `tmp_material` (`material_id`, `key`, `name`, `stock`, `material_classifier_id`, `unit_measure_id`, `line`, `sub_line`, `material_coust`)
        //  VALUES (NULL, '8484894686', 'Ejemplo tmp_material', '100', '4', '10', '17', '15', '100.00');");
        ...
        $resultado3 = $mysqli2->query("SELECT * FROM material");
        ...
        while ($fila = $resultado2->fetch_assoc()) {
            ...
            $array_material_classifier_id[$indice] = TRIM($fila['material_classifier_id']);
            $array_unit_measure_id[$indice] = TRIM($fila['unit_measure_id']);

            $indice++;
            // echo($fila['material_id']." ".$fila['name']." ".$fila['key']." ".$fila['stock']." ".$fila['material_classifier_id']." ".$fila['unit_measure_id'].'<br>');
            // echo("<script> alert('Stock diferente: tabla Material:".$fila['name']." ".$fila['stock']." "." tabla tmp_matrial: ".$fila2['name']." ".$fila2['stock']."'); </script>");
        }
        // echo($indice."<br>");
        // echo("//////////////////////Materiales//////////////".'<br>');
        $indice=0;
        while ($fila = $resultado3->fetch_assoc()) {
            ...
            $arrayMaterial[$indice]= TRIM($fila['key']);
            $arrayStockMaterial[$indice] = TRIM($fila['stock']);
            $arrayMaterialName[$indice] = TRIM($fila['name']);

            if (in_array($fila['key'],$arrayTemporal)) {
                # code...
                $update =  "UPDATE `material` SET `status_id` = '1' WHERE `material`.`material_id` = ".$fila['material_id'];
                    ...
                    if ($fila['key']==$arrayTemporal[$i]) {
                        ...
                        if ($fila['stock'] == $arrayStockTemporal[$i]) {
                            ...
                            if (TRIM($fila['name']) == $arrayTemporalName[$i]) {
                                ...
                                // echo("El nombre del material ".$fila['name']." no es igual a la tabla temporal, tabla 'Material' = ".$fila['name']." tabla 'tmp_material'= ".$arrayTemporalName[$i]." <br>");
                                $update =  "UPDATE `material` SET `name` = '".$arrayTemporalName[$i]."' WHERE `material`.`material_id` = ".$fila['material_id'];
                                $rs = mysqli_query($mysqli2, $update);
                            }
                        }else{
                            // echo("El stock del material ".$fila['key']." no es igual a la tabla temporal, tabla 'Material' = ".$fila['stock']." tabla 'tmp_material'= ".$arrayStockTemporal[$i]." <br>");
                            $update =  "UPDATE `material` SET `stock` = '".$arrayStockTemporal[$i]."' WHERE `material`.`material_id` = ".$fila['material_id'];
                            $rs = mysqli_query($mysqli2, $update);
                            if (TRIM($fila['name']) == $arrayTemporalName[$i]) {
                ...
                // echo($indice." - No existe la clave del material"."<br>");
                // echo($fila['name']." - ".$fila['key']." - ".$fila['status_id']."<br>");
                $update =  "UPDATE `material` SET `status_id` = '2' WHERE `material`.`material_id` = ".$fila['material_id'];
                $rs = mysqli_query($mysqli2, $update);
        ...
        // echo("Cantidad de registros de la tabla materiales: ".count($arrayMaterial)."<br>");

        // echo("Cantidad de registros de la tabla tmp_materiales: ".count($arrayTemporal).'<br>');

        /*Falta verificar si en la tabla tmp_material tiene nuevos registros o actualizaciones de los que estan almacenado en la tabla material*/
        // echo(count($arrayMaterial)."<br>");

        for ($index=0; $index < count($arrayTemporal); $index++) {
            $mysqli2->query("SET @user_id = 9999");
            if (in_array($arrayTemporal[$index], $arrayMaterial)) {
                ...
                VALUES (NULL,'".$arrayTemporal[$index]."','".$arrayTemporalName[$index]."','".$arrayStockTemporal[$index]."','".$array_material_classifier_id[$index]."','".$array_unit_measure_id[$index]."','1','9999')");
            }
        }        
       
        
    // echo("<script>alert('Se actualizó la base de datos');</script>");
    header("Location: http://192.168.3.8/tmp_tools_update.php");
