<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group" >
            {{ Form::label( __('Key')) }}
            {{ Form::text('key', $customer->key, ['class' => 'form-control' . ($errors->has('key') ? ' is-invalid' : ''), 'placeholder' => __('customer_id'), 'maxlength' => 5, 'minlength'=>5]) }}
        ...
        <div class="form-group">
            ...
            <input class="form-control" id="phone" type="tel" name="phone" value="(___) ___-__-__" pattern="^\(\s+)?\(?(17|25|29|33|44)\)?(\s+)?[0-9]{3}-?[0-9]{3}-?[0-9]{2}$" required> <br>
