<form action="{{ route('tool-assigneds.update', $toolAssigned->order_tool_id) }}" method="post" enctype="multipart/form-data">
    {{ method_field('patch') }}
    {{ csrf_field() }}
    <div class="modal fade" id="dialogo8{{ $toolAssigned->order_tool_id }}" data-backdrop="static">
            ...
            <div class="modal-content">
                ...
                <!-- cuerpo del diálogo -->
                    <div class="modal-body">
                        <div class="card-body">
                            <b>{{ __('Stock') }}: </b><input type="text" id="text1" name="text1" value="{{$toolAssigned->tool->stock}}" style="width:70px;" disabled> &nbsp;&nbsp; 
                            <b>{{ __('unit_measure') }}: </b><input type="text" id="text2" name="text2" value="{{$toolAssigned->tool->unitMeasure->name}}" style="width:80px;" disabled><br> <br>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                {{ Form::number('quantity', $toolAssigned->quantity, ['class' => 'form-control' . ($errors->has('quantity') ? ' is-invalid' : ''), 'placeholder' => 'Quantity', 'step'=>'0.1', 'min'=>'0','required']) }}
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12" hidden>
                            <div class="form-group">
                                ...
                                {{ Form::text('order_service_id', $toolAssigned->order_service_id, ['class' => 'form-control' . ($errors->has('order_service_id') ? ' is-invalid' : ''), 'placeholder' => 'service_order_id']) }}
