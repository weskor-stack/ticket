...
class AddForeignKeysToEmployeeTable extends Migration
{
    ...
    public function up()
    {
        Schema::table('employee', function (Blueprint $table) {
            ...
            $table->foreign(['supervisor_id'], 'fk_employee_supervisor1')->references(['supervisor_id'])->on('supervisor')->onUpdate('NO ACTION')->onDelete('NO ACTION');
        });
    }
    ...
    public function down()
    {
        Schema::table('employee', function (Blueprint $table) {
            ...
            $table->dropForeign('fk_employee_supervisor1');
        });
    }
}
